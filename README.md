...
<a href="https://travis-ci.org/cloudposse/terraform-aws-iam-assumed-roles"><img src="https://travis-ci.org/cloudposse/terraform-aws-iam-assumed-roles.svg?branch=master" alt="Build Status"/></a><a href="https://github.com/cloudposse/terraform-aws-iam-assumed-roles/releases/latest"><img src="https://img.shields.io/github/release/cloudposse/terraform-aws-iam-assumed-roles.svg" alt="Latest Release"/></a><a href="https://slack.cloudposse.com"><img src="https://slack.cloudposse.com/badge.svg" alt="Slack Community"/></a>
...
Hit us up in [Slack](https://cpco.io/slack?utm_source=github&utm_medium=readme&utm_campaign=cloudposse/terraform-aws-iam-assumed-roles&utm_content=slack), in the `#cloudposse` channel.
